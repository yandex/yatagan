...
class KcpLexicalScope(
     ...
     */
    val resolvedClasses: Set<IrClass> get() = resolvedClassesMutable
    ...
    fun getType(type: IrType): Type = kcpType(type)

    fun getTypeDeclaration(declaration: IrClass): TypeDeclaration {
        return kcpType(declaration.symbol.defaultType).declaration
    }
}

internal object KcpScopeKey : Extensible.Key<KcpLexicalScope, LexicalScope.Extensions>
